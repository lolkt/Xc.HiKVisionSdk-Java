...
/** 
 增量获取组织数据请求
*/
public class GetOrgListByTimeRangeRequest extends PagedRequest
{
	/** 
	...
	*/
	...
	public GetOrgListByTimeRangeRequest(int pageNo, int pageSize, java.time.LocalDateTime start)
	{
		this(pageNo, pageSize, start, null);
	}

//C# TO JAVA CONVERTER NOTE: Java does not support optional parameters. Overloaded method(s) are created above:
//ORIGINAL LINE: public GetOrgListByTimeRangeRequest(int pageNo, int pageSize, DateTime start, System.Nullable<DateTime> end = null)
	public GetOrgListByTimeRangeRequest(int pageNo, int pageSize, LocalDateTime start, LocalDateTime end)
	{

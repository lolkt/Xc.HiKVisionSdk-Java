...
public class TargetAttr
{
	...
	*/
	...
	public final void setDeviceChannel(int value)
	{
		DeviceChannel = value;
	}
	/** 
	...
	*/
	...
	public final String getImageServerCode()
	{
		return ImageServerCode;
	}
	public final void setImageServerCode(String value)
	{
		ImageServerCode = value;
	}
}
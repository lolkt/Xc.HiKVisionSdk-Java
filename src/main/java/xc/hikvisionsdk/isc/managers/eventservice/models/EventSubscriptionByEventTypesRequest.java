...
public class EventSubscriptionByEventTypesRequest extends BaseRequest
{
	...
	*/
	...
	public final void setSubType(SubscribeType value)
	{
		SubType = value;
	}
	/** 
	...
	*/
	public EventSubscriptionByEventTypesRequest(int[] eventTypes, String eventDest, SubscribeType subType, int[] eventLvl)
	{

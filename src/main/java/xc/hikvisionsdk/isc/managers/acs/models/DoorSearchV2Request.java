...
/** 
 查询门禁请求
*/
public class DoorSearchV2Request extends PagedRequest
{
	/** 
	 名称，模糊搜索，最大长度32，若包含中文，最大长度指不超过按照指定编码的字节长度，即getBytes("utf-8”).length
	*/
//C# TO JAVA CONVERTER TODO TASK: Java annotations will not correspond to .NET attributes:
//ORIGINAL LINE: [MaxLength(32)] public string Name {get;set;}
	private String Name;
	...
	*/
	public DoorSearchV2Request(int pageNo, int pageSize)
	{

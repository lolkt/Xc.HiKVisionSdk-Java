...
public class GenerateBarCodeRequest extends BaseRequest
{
	...
	*/
	...
	protected GenerateBarCodeRequest(String personId, String cardNo, Integer certType, String certNum, String phone, String employeeId, int duration)
	{
		this(personId, cardNo, certType, certNum, phone, employeeId, duration, 4);
	}

	protected GenerateBarCodeRequest(String personId, String cardNo, Integer certType, String certNum, String phone, String employeeId)
	{
		this(personId, cardNo, certType, certNum, phone, employeeId, 1440, 4);
	}

//C# TO JAVA CONVERTER NOTE: Java does not support optional parameters. Overloaded method(s) are created above:
//ORIGINAL LINE: protected GenerateBarCodeRequest(string personId, string cardNo, System.Nullable<int> certType, string certNum, string phone, string employeeId, int duration = 1440, int maxLock = 4)
	protected GenerateBarCodeRequest(String personId, String cardNo, Integer certType, String certNum, String phone, String employeeId, int duration, int maxLock)
	{
		PersonId = personId;
		CardNo = cardNo;
		CertType = certType;
...
//ORIGINAL LINE: public static GenerateBarCodeRequest NewByPersonId(string personId, int duration = 1440, int maxLock = 4)
	...
	*/
	...
	public static GenerateBarCodeRequest NewByCert(int certType, String certNum, int duration)
	{
		return NewByCert(certType, certNum, duration, 4);
	}

	public static GenerateBarCodeRequest NewByCert(int certType, String certNum)
	{
		return NewByCert(certType, certNum, 1440, 4);
	}

//C# TO JAVA CONVERTER NOTE: Java does not support optional parameters. Overloaded method(s) are created above:
//ORIGINAL LINE: public static GenerateBarCodeRequest NewByCert(int certType, string certNum, int duration = 1440, int maxLock = 4)
	public static GenerateBarCodeRequest NewByCert(int certType, String certNum, int duration, int maxLock)
	{

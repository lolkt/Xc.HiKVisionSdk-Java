...
/** 
 增量获取卡片数据请求
*/
public class CardTimeRangeRequest extends PagedRequest
{
	...
	*/
	...
	public CardTimeRangeRequest(int pageNo, int pageSize, java.time.LocalDateTime startTime)
	{
		this(pageNo, pageSize, startTime, null);
	}

//C# TO JAVA CONVERTER NOTE: Java does not support optional parameters. Overloaded method(s) are created above:
//ORIGINAL LINE: public CardTimeRangeRequest(int pageNo, int pageSize, DateTime startTime, System.Nullable<DateTime> endTime = null)
	public CardTimeRangeRequest(int pageNo, int pageSize, LocalDateTime startTime, LocalDateTime endTime)
	{

...
public class FaceGroupViewModel extends BaseScreenViewModel
{

	public FaceGroupViewModel(IWindowManager windowManager, IContainer container)
	{
...
//ORIGINAL LINE: public async Task FaceGroup()
	public final Task FaceGroup()
	{
...
//C# TO JAVA CONVERTER TODO TASK: There is no equivalent to 'await' in Java:
			...
			WindowManager.ShowMessageBox(String.format("查询成功，共有%1$s个人脸分组", result.Data.Length));
		}
